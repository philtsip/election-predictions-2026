...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen pb-24">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 mt-8 sm:mt-12 space-y-12">
        ...
        {racesQ.data && (
          <>
            ...
            <ChamberBlock
              title="Governor"
              subtitle="36 seats up · tracking the Cook toss-ups + Florida"
            >
              <ChamberSection
                chamber="governor"
                races={racesQ.data}
...
function Footer() {
  return (
    <footer className="max-w-4xl mx-auto px-4 sm:px-6 mt-24 text-xs text-muted-foreground">
